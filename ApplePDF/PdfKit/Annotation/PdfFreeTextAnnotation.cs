...
namespace ApplePDF.PdfKit.Annotation
{
    ...
    /// </summary>
    public class PdfFreeTextAnnotation : PdfAnnotation_ReadonlyPdfPageObj, IPdfFreeTextAnnotation
    {
        ...
        public string? Text { get => GetStringValueFromKey(); set => SetStringValueForKey(value); }

        public Color? TextColor { get => GetAnnotColor(); set => SetAnnotColor(value); }
    }
}
